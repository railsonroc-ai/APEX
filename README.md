...
**Próxima etapa:** enriquecer os tipos de tarefa com requisitos/artefatos e rubricas profissionais específicas, ainda sem construir um ChallengeEngine completo ou execução de código.
