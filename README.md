...
**Próxima etapa:** conectar o lifecycle de sessão à interface (PAUSAR → RETOMAR DIRETO / REVISAR ANTES) e depois enriquecer tarefas com requisitos/artefatos e rubricas profissionais específicas, ainda sem ChallengeEngine completo ou execução de código.
