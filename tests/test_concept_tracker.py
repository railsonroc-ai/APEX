...
def test_completed_variable_storage_allows_only_integer_declaration_successor():
    state = {
        "area": "ads",
        "current_concept_id": "ads.algorithms.variable_storage",
        "current_concept": "variável como armazenamento nomeado",
        "stage": "concluido",
    }
...
def test_completed_read_variable_allows_only_write_variable_successor():
    state = {
        "area": "ads",
        "current_concept_id": "ads.algorithms.read_variable",
        "current_concept": "entrada em variável com leia",
        "stage": "concluido",
    }
