...
def sync_executable_curriculum_v5(connection):
    """Migration histórica congelada na quarta microcompetência."""
...
def sync_executable_curriculum_v7(connection):
    """Migration histórica congelada na sexta microcompetência."""
...
def sync_executable_curriculum_v8(connection):
    """Migration histórica congelada na sétima microcompetência."""
...
def sync_executable_curriculum_v9(connection):
    """Migration histórica congelada na oitava microcompetência."""
...
def sync_executable_curriculum_v11(connection):
    """Migration histórica congelada na décima microcompetência."""
...
def sync_executable_curriculum_v12(connection):
    """Adiciona saída de variável com escreva como décima primeira microcompetência."""
...
MIGRATIONS = (
    ...
    Migration(
        21,
        "sync_executable_curriculum_v8",
        sync_executable_curriculum_v8,
    ),
    Migration(
        22,
        "sync_executable_curriculum_v9",
        sync_executable_curriculum_v9,
    ),
    Migration(
        23,
    ...
    Migration(
        25,
        "sync_executable_curriculum_v12",
        sync_executable_curriculum_v12,
    ),
)
