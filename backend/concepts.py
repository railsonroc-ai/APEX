...
WRITE_VARIABLE_SEED = ConceptSeed(
    "ads.algorithms.write_variable",
    "ads",
    "saída de variável com escreva",
    (
        "saida de variavel com escreva",
        "escreva com variavel",
        "escreva variavel",
...
CATALOG_V11_SEEDS = CORE_CONCEPT_SEEDS + (
    ORDERED_STEPS_SEED,
    GOAL_RESULT_SEED,
    INPUT_PROCESS_OUTPUT_SEED,
    STRUCTURED_SEQUENCE_SEED,
